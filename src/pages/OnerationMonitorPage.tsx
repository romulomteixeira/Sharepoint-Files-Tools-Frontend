  ...
  return (
    <>
      <div className="page-head">
        <div>
          <h1 className="page-title">Monitor de Oneração</h1>
          <p className="page-sub">Arquivos que mais consumiram espaço no período selecionado.</p>
        </div>
      ...
      <div className="card" style={{ padding: 0 }}>
        <div className="card-head">
          <div>
            <div className="card-title">Top arquivos no período</div>
            <div className="small muted">Ranking por tamanho total: arquivo atual + espaço conhecido das versões.</div>
          </div>
        ...
        {scanId && loading && <p className="small muted" style={{ padding: 28, textAlign: 'center' }}>Carregando análise...</p>}
