...
export default function NotFoundPage(): React.ReactElement {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '6rem 1rem', gap: '1rem' }}>
      ...
      <p style={{ fontSize: '1.1rem', color: 'var(--muted)' }}>Página não encontrada.</p>
      <Link to="/" style={{ color: 'var(--accent)', textDecoration: 'none', fontWeight: 600 }}>← Voltar ao Dashboard</Link>
    </div>
  );
}
